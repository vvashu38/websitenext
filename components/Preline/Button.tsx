...
export type ButtonProps = {
  type?: 'solid' | 'outline' | 'ghost' | 'soft' | 'white' | 'none' | 'nofocus' | 'link';
...
const TypeTws = {
  solid:
    'inline-flex justify-center items-center gap-2  border border-transparent font-semibold bg-blue-500 text-white hover:bg-[#2D6F6C] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800',
  outline:
    'inline-flex justify-center items-center gap-2 rounded-md border-1 border-primary font-semibold text-blue-500 hover:text-white hover:bg-blue-500 hover:border-primary focus:outline-none focus:ring-offset-2 transition-all text-sm dark:border-primary dark:hover:border-primary',
  nofocus:
    'inline-flex justify-center items-center gap-2 rounded-md border-1 border-primary font-semibold text-primary transition-all hover:bg-[#2D6F6C] text-sm dark:border-primary dark:hover:border-primary',
  none: "",
  ghost:
...
function getClasses(
  ...
  return clsx(SizeTws[size || 'default'], classes);
}
