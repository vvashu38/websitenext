...
export const InputThemes: {
  ...
  state: {
    default: 'border-gray-200 focus:border-blue-500 focus:ring-blue-500 dark:focus:border-blue-400 dark:border-gray-700',
    error: 'border-red-500 focus:border-red-500 focus:ring-red-500 dark:bg-white dark:border-red-400',
    success: 'border-green-500 focus:border-green-500 focus:ring-green-500 dark:bg-white dark:border-green-400',
    none: '',
  },
  rounded: {
    md: 'rounded-md',
...
export function getInputCls({
  ...
  return clsx(
    'block border text-sm dark:text-gray-400 dark:bg-white',
