import React, { InputHTMLAttributes, KeyboardEvent, KeyboardEventHandler, TextareaHTMLAttributes, forwardRef } from 'react';
...
export type TextareaProps = Omit<TextareaHTMLAttributes<HTMLTextAreaElement>, 'size'> & InputBaseProps;
